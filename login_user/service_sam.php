...
<div class="tab-content">
  <div class="tab-pane active" id="package" role="tabpanel" aria-labelledby="package-tab">
    ...
    <form action="manage_cart.php" method="post">
        <div class="service__card">
            ...
            <p>Includes: Handspa and Hand Paraffin Wax</p>
              ...
              <div class="service__btn">
                <button name="add_to_cart" type="submit">Book Now</button> 
                <input type="hidden" name="item_name" value="Hands Down Package">
      ...
      <form action="manage_cart.php" method="post">
        <div class="service__card">
          ...
          <div class="service__btn"><button name="add_to_cart" type="submit">Book Now</button> 
                  <input type="hidden" name="item_name" value="Pamper me Package">            
      ...
      <div class="service__card">
          ...
          <div class="service__btn"><button name="add_to_cart" type="submit">Book Now</button> 
              <input type="hidden" name="item_name" value="Deluxe Package">   
    ...
    <div class="service__card">
          ...
          <div class="service__btn"><button name="add_to_cart" type="submit">Book Now</button> 
              <input type="hidden" name="item_name" value="Happy Feet Package">
    ...
    <div class="service__card">
          ...
          <div class="service__btn"><button name="add_to_cart" type="submit">Book Now</button> 
              <input type="hidden" name="item_name" value="Sitting Pretty Hand Package">   
            <p id="price">&#x20b1 450.00</p>
            <input type="hidden" name="price" value="450">
        </div>
    </div>
    ...
    <div class="service__card">
          ...
          <div class="service__btn"><button name="add_to_cart" type="submit">Book Now</button> 
              <input type="hidden" name="item_name" value="Paraffin Wax Package">
    ...
    <form action="manage_cart.php" method="post">
      <div class="service__card">
            ...
            <div class="service__btn"><button name="add_to_cart" type="submit">Book Now</button> 
                <input type="hidden" name="item_name" value="VIP Pamper Package">
  ...
  <div class="tab-pane" id="eyebrow" role="tabpanel" aria-labelledby="eyebrow-tab">
    <div class="service__wrapper img-fluid">
    <div class="service__card">
